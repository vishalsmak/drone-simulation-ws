...
if __name__ == '__main__':
    ...
    set_point_array = np.array([0., 0., 4, 0.])
    i = 0
    ...
    while not rospy.is_shutdown():
        ...
        try:
            trans = tfBuffer.lookup_transform('marker_frame', 'base_stabilized', rospy.Time()).transform
            ...
            pid_twist, state = pid(current_pose, set_point_array, state)
            ...
            if i >= 10:
                set_point_array = np.array([0., 0., 0, 0.])
